...
For agents without direct shell access. All 67 tools available via MCP protocol.
...
Every agent gets access to the same 67 MCP tools. The most important ones:
