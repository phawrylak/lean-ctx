...
flowchart TB
    ...
    subgraph dispatch [Dispatch and Governance]
        ...
        HybridDispatch["Hybrid Dispatch — Context Server (62 tools)"]
    ...
    HybridDispatch -->|"registry (62 tools)"| ToolRegistry
